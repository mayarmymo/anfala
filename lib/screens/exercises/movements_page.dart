  ...
  final List<Map<String, dynamic>> movements = [
    {
      ...
      "done": false,
      "image": "assets/images/alef_fatha.jpg"
    },
    {
      "title": "الضمة",
      "desc": "نضم الشفتين عند النطق بها",
      "done": false,
      "image": "assets/images/alef_damma.jpg"
    },
    {
      "title": "الكسرة",
      "desc": "نبتسم قليلاً عند النطق بها",
      "done": false,
      "image": "assets/images/alef_kasra.jpg"
    },
  ];
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text("ما هي الحركة التي على الحرف الذي يمسكه بينو",
            ...
            // تم إزالة المربع لجعل الصور مدمجة بسلاسة مع الخلفية
            ShaderMask(
  ...
  Future<void> _showResult() async {
    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        surfaceTintColor: Colors.white, // لون السطح أبيض
