...
import 'package:anfalahmad/pages/store_page.dart' hide pinoNavy, pinoOrange;
import 'package:anfalahmad/screens/motivation/achievements_page.dart'
    hide pinoNavy, pinoOrange;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        selectedItemColor: pinoNavy,
        unselectedItemColor: Colors.grey,
        currentIndex: _selectedIndex,
        onTap: _onItemTapped,
        selectedLabelStyle: const TextStyle(
            fontFamily: appFont, fontSize: 12, fontWeight: FontWeight.bold),
        unselectedLabelStyle:
            const TextStyle(fontFamily: appFont, fontSize: 12),
        items: const [
